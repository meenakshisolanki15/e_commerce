...
import WomenZoom from '../WomenZoom';
...
const WomenModal =(props)=>{
    return (
        <>
            <Dialog  open={true} className="productModal" onClose={()=>props.closeWomenModal()} >
                <Button className='close_'  onClick={()=>props.closeWomenModal()}><MdClose/></Button>
