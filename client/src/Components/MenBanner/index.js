            ...
            <div className="homeBannerSection">
                <Swiper
                    ...
                    className="mySwiper">
                        ...
                        <SwiperSlide>
                            <div className="item">
                                <img src={'https://sslimages.shoppersstop.com/sys-master/root/h82/h84/33014150791198/ucb-web_48-jso.jpg'} className="w-100"/>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="item">
                                <img src={'https://sslimages.shoppersstop.com/sys-master/root/hb6/h4e/32916137967646/Killer-web_47-h9.jpg'} className="w-100"/>
                            </div>
                        </SwiperSlide>
                    </Swiper>
            </div>
