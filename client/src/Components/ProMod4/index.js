    ...
    return (
        <>
            ...
            <Dialog  open={true} className="productModal" onClose={()=>props.closeProductModal()} >
                ...
                <h4 class="mb-1 font-weight-bold">Fratini  </h4>
                ...
                <div className='row mt-2 productDetailsModal'>
                    ...
                    <div className='col-md-7'>
                        <div className='d-flex info align-items-center mb-3'>
                            <span className='oldPrice lg mr-2'> Rs 19000</span>
                            <span className='netPrice text-danger lg'> Rs. 17000</span>
                        </div>
