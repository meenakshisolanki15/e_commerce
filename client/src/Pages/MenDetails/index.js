                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-7 pl-5 pr-5">
                            <h2 className="hd text-capitalize">   <b>Fratini</b>   Stripes Cotton Regular Fit Men's Shirt </h2>
                                    ...
                                    Start your new fashion journey with Janasya
                                     and explore the exclusive collection with a
                                      wide range of dress featuring timeless designs
                                       ...
                                       Aditya Birla Fashion And Retail Limited, Kasaba Hobli,
                                    Anekal Taluk Bangalore Urban district,Retail Ltd
                                    Located at Sy no,517/2, 52528, 529, 530, 531,Of Madivala Village.
                                     </p>
                                </div>
                            }
